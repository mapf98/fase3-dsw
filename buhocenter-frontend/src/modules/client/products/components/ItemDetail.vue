<template>
  <v-container
    class="mt-5"
    style="max-width: none !important; background: #ffffff;"
  >
    <v-row>
      <v-col cols="12" lg="9" md="8" sm="12">
        ...
        >
          <v-row>
            ...
            >
              <p
                class="overline font-weight-light caption"
          ...
          <v-row v-if="itemDetailLoaded" class="pa-0">
            ...
            <v-col
              cols="12"
              sm="12"
              class="d-xs-flex d-sm-flex d-md-none d-lg-none"
            >
              <v-row>
                ...
                <v-row fill-width class="pa-1 mx-auto">
                  <v-btn
                    ...
                    style="height: 50px;"
                  >
                    <v-icon left class="d-flex align-center"
    ...
    >
      {{
        isProduct()
          ? $t("PRODUCT_ADD_TO_CART_SUCCESS")
          : $t("SERVICE_ADD_TO_CART_SUCCESS")
      }}
      <v-btn color="white" text @click="itemAddedToCart = false">{{
        $t("CLOSE")
      }}</v-btn>
    </v-snackbar>
    <v-snackbar
      v-model="errorAddingItemToCart"
      top
      :timeout="timeout"
      color="error"
    >
      {{
        isProduct()
          ? $t("PRODUCT_ADD_TO_CART_ERROR")
          : $t("SERVICE_ADD_TO_CART_ERROR")
      }}
      <v-btn color="white" text @click="errorAddingItemToCart = false"
        >Cerrar</v-btn
      >
    </v-snackbar>
    <v-snackbar
