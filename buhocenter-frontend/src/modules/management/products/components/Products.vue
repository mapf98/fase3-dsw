<template>
    <div class="container-page" style="position: relative;">
        ...
        <v-snackbar v-model="snackbarCatalogues" top :timeout="timeout" color="error">
            {{ $t('ERROR_GET_CATALOGUES') }}
            <v-btn color="white" text @click="snackbarCatalogues = false">Cerrar</v-btn>
        </v-snackbar>
        <v-snackbar v-model="snackbarSuccessCreated" top :timeout="timeout" color="success">
        ...
        <v-snackbar v-model="snackbarProviders" top :timeout="timeout" color="error">
            {{ $t('ERROR_LOAD_PROVIDERS') }}
            <v-btn color="white" text @click="snackbarProviders = false">Cerrar</v-btn>
        </v-snackbar>
        <v-snackbar v-model="snackbarCategories" top :timeout="timeout" color="error">
                                ...
                                <v-card-text>
                                    <v-container>
                                        ...
                                        <v-alert type="error" v-if="snackbarErrorCreate">
                                            ¡Name, description, price , shipping price , minumun quantity
                                            avalaible, image , dimensions and brand required!
                                        </v-alert>
                                        <v-alert type="error" v-if="snackbarMoreMinThanAvai">
                                            ¡You can't register less products in inventary than the minimun
                                            quantity avalible you choose!
                                        </v-alert>
