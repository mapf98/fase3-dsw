          ...
          <v-container class="mb-4">
            <v-row justify="center">
              <h2>{{$t('SHIPPING_ADDRESS')}}</h2>
                <br>
                <h5 style="width: 100%;text-align: center">{{$t('SELECT_SHIPPING_ADDRESS')}}</h5>
            </v-row>
            <v-row>
                ...
                >
                  ...
                  >
                    <v-card-text class="font-weight-bold">
                      <i class="fas fa-map-marker-alt mb-4 d-flex justify-center"
                         :style="`font-size: 40px; color: ${ address.setDefault ? '#907F46' : '#111' }`"></i>
