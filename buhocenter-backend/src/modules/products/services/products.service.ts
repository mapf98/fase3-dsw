...
export class ProductsService {
    ...
    private async getProductAverageRating(products: Product[]): Promise<void> {
        this.logger.debug(`getProductAverageRating...`);
     ...
     */
    public async getProducts(parameters: ProductParameters): Promise<PaginatedProducts> {
     ...
     */
    private randomProducts(products: Product[]): Product[] {
        const randomProducts = products.sort((a, b) => Math.random() - 0.5);
        return [...randomProducts].slice(0, 5);
    }

    public async updateProduct(product: Partial<Product>): Promise<Product> {
     ...
     * @returns void
     */
    public async updateProductRating(product: Partial<Product>, transactionEntityManager: EntityManager) {
    ...
    private async getPdfClientData(paymentId: number) {
    ...
    private async getPdfCartData(paymentId: number) {
        return await this.productsRepository.query(
                ...
                content: [
                        ...
                        table: {
                            ...
                            body: [
                                [
                                    '',
                                    {
                                        text: `Final Details for Order : ${pdfCartData[0].id}`,
                                        style: 'tableHeader',
                                        alignment: 'center',
                                    },
                                    '',
                    ...
                    },
                    {
                        ...
                        table: {
                            ...
                            body: [
                                ...
                                [
                                    {
                                        text: `Buhocenter Order number`,
                                        alignment: 'left',
                                        style: 'tableHeader',
                                    },
                                    {
                                        text: `${pdfCartData[0].id}`,
                                        alignment: 'left',
                                        colSpan: 2,
                                        style: 'tableHeader',
                                    },
                                    { text: `Invoice ID: pdfC`, alignment: 'left' },
                                ],
                                [
                                    { text: `Order Total`, alignment: 'left', style: 'tableHeader' },
                                    {
                                    ...
                                    { text: `TransactionID:pd`, alignment: 'left' },
                                ],
                            ],
                        },
                        layout: 'noBorders',
                    },
                    {
                        ...
                        table: {
                            ...
                            body: [
                                ...
                                [
                                    { text: `name: ${pdfClienteData[0].name}`, alignment: 'left' },
                                    { text: `last name: ${pdfClienteData[0].last_name}`, alignment: 'left' },
                                ],
                                [
                                    {
...

                    {
                        ...
                        table: {
                            ...
                            body: [
                                [
                                    { text: 'Shipping Address', style: 'tableHeader' },
                                    { text: `zip code: ${pdfClienteData[0].zip_code}` },
                                ],
                                [
                                    {
                                ...
                                [
                                    { text: `city: ${pdfClienteData[0].city}`, alignment: 'left' },
                                    { text: `state: ${pdfClienteData[0].state}` },
                                ],
                            ],
                        },
                        layout: 'noBorders',
                    },
                    {
                        ...
                        table: {
                            widths: ['*'],
                            // keepWithHeaderRows: 1,
                            body: [[{ text: 'Products Ordered', style: 'header' }]],
                        },
                        layout: 'noBorders',
                    },
                    {
                        ...
                        table: {
                            ...
                            body: [
                                [
                                    { text: 'Name', alignment: 'center', style: 'header' },
                                    { text: 'Quantity', alignment: 'center', style: 'header' },
                                    { text: 'Ind. price', alignment: 'center', style: 'header' },
                                    { text: 'Discount', alignment: 'center', style: 'header' },
                                    { text: 'Import', alignment: 'center', style: 'header' },
                                ],
                            ],
                        },
                        layout: {
                        ...
                        table: {
                            ...
                            body: [
                                ...
                                [
                                    ...
                                    { text: `${pdfClienteData[0].total}`, alignment: 'center' },
                                ],
                                [
